...
//        );
//
//        Mockito.when(repository.findStatisticsByParams(any(), any(), any(), eq(false)))
//                .thenReturn(mockData);
//
//        // Вызов метода
...
//        );
//
//        Mockito.when(repository.findStatisticsByParams(any(), any(), any(), eq(true)))
...
//        );
//
//        Mockito.when(repository.findStatisticsByParams(any(), any(), eq(List.of("/events", "/events/1")), eq(false)))
//                .thenReturn(mockData);
//
